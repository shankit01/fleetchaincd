...
router.route('/login').get(function(req, res){
	//ssn=req.session;
	res.render('login.jade', {title: 'Please Sign In To Fleetchain',bag: build_bag(req)});
});
...
router.route('/p1').get(function(req, res){
	res.render('part1', {title: 'Fleetchain Uberdotcom', bag: build_bag(req)});
});
...
router.route('/p2').get(function(req, res){
	res.render('part2', {title: 'Fleetchain Uberdotcom', bag: build_bag(req)});
});
